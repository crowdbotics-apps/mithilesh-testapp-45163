"""
Django settings for mithilesh_testapp_45163 project.
...
ROOT_URLCONF = 'mithilesh_testapp_45163.urls'
...
WSGI_APPLICATION = 'mithilesh_testapp_45163.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "mithilesh_testapp_45163 API",
    "DESCRIPTION": "API documentation for mithilesh_testapp_45163 App",
    "VERSION": "v1",
}
